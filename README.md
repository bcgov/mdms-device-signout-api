...
[MDMS Generic Device Sign-out API](https://github.com/bcdevops/mdms-device-signout-api)

[MDMS Generic Device Sign-out Mobile Application](https://github.com/bcdevops/mdms-device-signout-app)
